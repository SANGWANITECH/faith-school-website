...
export default function HomeAboutUs() {
  ...
  const staff = [
    {
      img: "/head-teacher.jpg",
      role: "The Director",
      name: "Mr Kanyimbo",
    },
    {
      img: "/deputy-teacher.jpg",
      role: "Head Teacher",
      name: "Mr Kalinga",
    },
  ];
    ...
    <section className="relative w-full py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-gray-700 text-base md:text-lg max-w-4xl mx-auto mb-10">
          Welcome to <span className="text-teal-600 font-semibold">Faith Private Secondary School</span>, a nurturing destination for children seeking excellence in education.
          Established in 2010 in Chitipa, Malawi, we provide a holistic learning environment that fosters academic, personal, and leadership growth.
