    ...
    <section className="w-full py-10 md:py-14 bg-gray-50">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="space-y-4 text-gray-700 text-base md:text-lg leading-relaxed max-w-3xl mx-auto">
          <p>
            Faith Private Secondary School was founded in <strong>2010</strong> in Chitipa, Malawi, beginning with just two classrooms, 50 students, and a handful of dedicated teachers in a renovated hall , driven by a vision to provide quality secondary education.
          </p>
          <p>
