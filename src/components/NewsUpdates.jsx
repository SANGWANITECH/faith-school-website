  ...
  const news = [
    {
      ...
      desc: "Exciting news! Starting in 2026, Faith Private Secondary School will introduce French as part of our curriculum to give students a global advantage.",
    ...
    },
    {
      ...
      img: "/graduation-2025.jpg",
    },
    {
      title: "Alumnus Launches a Tech Company",
      desc: "Proud moment! Former Faith student, now at University of Malawi, co-founded RAMTECH, a tech company offering innovative digital solutions across Malawi.",
    ...
    <section className="w-full py-12 md:py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-base md:text-lg text-gray-700 max-w-3xl mx-auto mb-8 md:mb-12">
          We Offer News Updates & Announcements About Our School Faith Secondary School.
        </p>
