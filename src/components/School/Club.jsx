  ...
  const clubs = [
    {
      ...
      desc: "SCOM builds faith and spiritual growth through Bible study, prayer, fellowship, and outreach activities that strengthen Christian values.",
    ...
    <section className="w-full py-12 md:py-20 bg-gray-300">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-base md:text-lg text-gray-700 max-w-3xl mx-auto mb-8 md:mb-12">
          Join Our Vibrant Clubs: SCOM, CCAPSO, WILDLIFE, and TECH-HUB to Develop Skills, Faith, Leadership, and Creativity.
        </p>
